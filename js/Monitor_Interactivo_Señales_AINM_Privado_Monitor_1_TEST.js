...
var App = {
     channels: {
        ...
        'OHIGGINS_TELECANAL': {
            'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠOHIGGINS | TELECANAL STA. CRUZ',
        ...
        'ARAUCANIA_TELEANGOL': {
            'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠARAUCANIA | TELEANGOL',
    ...
    n.classList.remove("BotonTV_Monitor1_Señales");
    n.classList.add("BotonTV_Monitor1_SeñalSeleccionada");
}
    },
remove: function(canal) {
    ...
    if (findCanal != null) {
        ...
        var n = document.querySelector('button[data-canal="' + canal + '"]');
        n.classList.remove("BotonTV_Monitor1_SeñalSeleccionada");
        n.classList.add("BotonTV_Monitor1_Señales");
    }
},
isMobile: function() {
    var check = false;
...
seedModal: function() {
    for (const llave in App.channels) {
        ...
        buttonTV.classList.add("BotonTV_Monitor1_Señales");
        buttonTV.setAttribute("data-canal", llave);
        buttonTV.innerHTML = App.channels[llave].nombre;
        let n = document.querySelector(".ContainerBotonesSeñales");
        n.appendChild(buttonTV);
        buttonTV.addEventListener("click", function () {
            if (buttonTV.getAttribute("class").includes("BotonTV_Monitor1_Señales")) {
                App.add(llave);
            } else if (buttonTV.getAttribute("class").includes("BotonTV_Monitor1_SeñalSeleccionada")) {
                App.remove(llave);
            }
        })
    };
