...
var App = {
     channels: {
        '24HTVN': {
            'nombre': 'CHACALLUTA, ARICA - R. ARICA',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <img class="embed-responsive-item" style="width: 100%; height:100%" src="http://service.iris.edu/irisws/timeseriesplot/1/query?net=IU&sta=ANMO&loc=00&cha=LHZ&start=currentutcday&end=86400&format=png" frameborder="0" scrolling="no"></img><a href="Señal24HTVN.html" class="FondoTitulosMonitor1"><div class="TextoTitulosMonitor1 waves-effect waves-gris">ㅤCANAL 24Hㅤ</div></a></div>'
        },
    },
    add: function(canal) {
