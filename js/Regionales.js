...
var App = {
     channels: {
        ...
        'ANTOFAGASTA_TALTAL_TV': {
            'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span>ANTOFAGASTA | TALTAL TV',
        ...
        'VALPARAISO_VALPARAISO_QUINTA_TV': {
            'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span>VALPARAISO | QUINTA TV',
        ...
        'OHIGGINS_TELECANAL': {
            'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span>OHIGGINS | TELECANAL STA. CRUZ',
        ...
        'MAULE_TV_MAULESUR': {
            'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span>MAULE | TV MAULE SUR',
        ...
        'AYSEN_ROCCO_TV': {
            'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span>AYSEN | ROCCO TV COYHAIQUE',
        ...
        'AYSEN_SANTAMARIA_TV': {
            'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span>AYSEN | SANTA MARIA TV COYHAIQUE',
        ...
        'AYSEN_CANAL11_AYSEN': {
            'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span>AYSEN | CANAL 11 PUERTO AYSEN',
