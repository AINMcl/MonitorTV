let LosCanales = [ 
    {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_24PLAY.svg"></img>',
        'url': 'Señal24HTVN.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CNNCHILE2.svg"></img>',
        'url': 'SeñalCNNCHILE.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_MEGANOTICIAS.svg"></img>',
        'url': 'SeñalMEGANOTICIAS.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_T13_ENVIVO.svg"></img>',
        'url': 'SeñalT13_ENVIVO.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_TVN.svg"></img>',
        'url': '../Monitores/Senal/WEB/SeñalTVN_IFRAME.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_MEGA.svg"></img>',
        'url': 'SeñalMEGA.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CHV.svg"></img>',
        'url': '../Monitores/Senal/WEB/SeñalCHV_IFRAME.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_Canal13.svg"></img>',
        'url': '../Monitores/Senal/WEB/SeñalCANAL13_IFRAME.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_LA_RED.svg"></img>',
        'url': 'SeñalLARED.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_TVMAS.svg"></img>',
        'url': 'SeñalTVMAS.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_UCVTV.svg"></img>',
        'url': 'Señal_UCVTV.html'
    }, {
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/LogoTV_WappTV.svg"></img>',
        'url': 'SeñalWAPPTV.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_NTV.svg"></img>',
        'url': 'SeñalNTV.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_TVCHILE.svg"></img>',
        'url': 'SeñalTVCHILE.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_Canal13E.svg"></img>ﾠE',
        'url': 'SeñalCANAL13_E.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠSEÑAL 1',
        'url': 'SeñalInterna24H_1.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠSEÑAL 2',
        'url': 'SeñalInterna24H_2.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠSEÑAL 3',
        'url': 'SeñalInterna24H_3.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠSEÑAL 4',
        'url': 'SeñalInterna24H_4.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠSEÑAL 5',
        'url': 'SeñalInterna24H_5.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠ<img style="height: 15px; width:auto:" src="imagenes/Logo_TVN.svg"></img>ﾠDOCUMENTACION TVN',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCeKSSTjG4r-Qvcpjnwgo0VQ&autoplay=true&mute=1'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CNNCHILE2.svg"></img>ﾠSEÑAL 1',
        'url': 'SeñalInternaCNNCHILE_1.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CHV.svg"></img>ﾠEVENTOSﾠ<img style="height: 15px; width:auto:" src="imagenes/Icono_SeñalOcasional.svg"></img>',
        'url': 'SeñalCHV_EVENTOS.html'
    },{
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Microfono1.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_RLN.svg"></img>ﾠ',
        ...
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Microfono1.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_ADNRADIO.svg"></img>ﾠ',
        'url': 'SeñalRADIO_ADN.html'
    }, {
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Microfono1.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_Radio_Cooperativa.svg"></img>ﾠ',
        'url': 'SeñalRADIO_COOPERATIVA.html'
    }, {
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Microfono1.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_BIOBIOCHILE.svg"></img>ﾠBIOBIO TV',
    ...
    
    {
        ...
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg"></img>',
        'url': 'SeñalSENADO_TV.html'
    }, {
        'nombre': 'DIPUTADOS TVﾠ',
        'url': 'Señal_CDTV.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_GOB.svg"></img>ﾠPRESIDENCIA',
        ...
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_Antena2.svg">ﾠAGENCIA UNO TVﾠ',
        'url': 'Señal_AGENCIAUNOTV_2.html'
    }, {
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_Antena2.svg">ﾠMEDIABANCOﾠ',
        ...
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_24HORAS.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCTXNz3gjAypWp3EhlIATEJQ&autoplay=true&mute=1'
    }, {
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_CNNCHILE2.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCpOAcjJNAp0Y0fhznRrXIJQ&autoplay=true&mute=1'
    },{
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_MEGANOTICIAS.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCkccyEbqhhM3uKOI6Shm-4Q&autoplay=true&mute=1'
    }, {
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_CHV_NOTICIAS.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCRsUoZYC1ULUspipMRnMhwg&autoplay=true&mute=1'
    }, {
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_T13.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCsRnhjcUCR78Q3Ud6OXCTNg&autoplay=true&mute=1'
    },{
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_TVN.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCaVaCaiG6qRzDiJDuEGKOhQ&autoplay=true&mute=1'
    }, {
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_MEGA.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCEpId-jtRABuZyX6D2z6FZQ&autoplay=true&mute=1'
    }, {
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_CHV.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UC8EdTmyUaFIfZvVttJ9lgIA&autoplay=true&mute=1'
    },{
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_Canal13.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCd4D3LfXC_9MY2zSv_3gMgw&autoplay=true&mute=1'
    }, {
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_24HORAS.svg"></img>',
        ...
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_CNNCHILE2.svg"></img>',
        'url': 'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Fcnnchile%2Flive%2F&show_text=0&mute=0'
    }, {
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_MEGANOTICIAS.svg"></img>',
        ...
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_T13.svg"></img>',
        ...
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_TVN.svg"></img>',
        'url': 'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Ftvn.cl%2Flive%2F&show_text=0&mute=0'
    }, {
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_MEGA.svg"></img>',
        'url': 'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2FMEGACL%2Flive%2F&show_text=0&mute=0'
    }, {
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_CHV.svg"></img>',
        ...
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_Canal13.svg"></img>',
    ...
    {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 1',
        'url': 'Senal/ConvencionConstitucional/Senal1.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 2',
        'url': 'Senal/ConvencionConstitucional/Senal2.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 3',
        'url': 'Senal/ConvencionConstitucional/Senal3.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 4',
        'url': 'Senal/ConvencionConstitucional/Senal4.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 5',
        'url': 'Senal/ConvencionConstitucional/Senal5.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 6',
        'url': 'Senal/ConvencionConstitucional/Senal6.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 7',
        'url': 'Senal/ConvencionConstitucional/Senal7.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 8',
        'url': 'Senal/ConvencionConstitucional/Senal8.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 9',
        'url': 'Senal/ConvencionConstitucional/Senal9.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 10',
        'url': 'Senal/ConvencionConstitucional/Senal10.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 11',
        'url': 'Senal/ConvencionConstitucional/Senal11.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 12',
        'url': 'Senal/ConvencionConstitucional/Senal12.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 13',
        ...
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg">ﾠSEÑAL 1ﾠ',
        'url': 'Señal_TVSENADO_1.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg">ﾠSEÑAL 2ﾠ',
        'url': 'Señal_TVSENADO_2.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg">ﾠSEÑAL 3ﾠ',
        'url': 'Señal_TVSENADO_3.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg">ﾠSEÑAL 4ﾠ',
        'url': 'Señal_TVSENADO_4.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg">ﾠSEÑAL 5ﾠ',
        'url': 'Señal_TVSENADO_5.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg">ﾠSEÑAL 6ﾠ',
    ...
    
    {
        ...
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_ALOMAX.svg"></img>ﾠDETECTOR SISMOS',
        'url': 'MonitorEARLY-EST_DETECTOR.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_ALOMAX.svg"></img>ﾠULTIMOS SISMOS',
        ...
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠISS CAM SD',
        'url': 'Señal_ISS_SD.html'
    },{
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠISS CAM HD',
        'url': 'Señal_ISS_HD.html'
    },{
        'nombre': '<img style="height: 20px; width:auto:" src="imagenes/Icono_Ubicacion.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_ESA.svg"></img>ﾠISS TRACKER MAP 1',
        ...
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA CSBF OPERATIONS',
        'url': 'SeñalNASATV_CSBF.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA LaRC',
        'url': 'SeñalNASATV_LaRC.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA WALLOPS',
        'url': 'SeñalNASATV_Wallops.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA NE02',
        'url': 'SeñalNASATV_NE02.html'
    },{
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA VIDEO',
        ...
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_ESA.svg"></img>ﾠESA WEB TV 1',
        'url': 'SeñalESATV_1.html'
    }, {
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_ROSCOSMOS.svg"></img>ﾠROSCOSMOS',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCOcpUgXosMCIlOsreUfNFiA&autoplay=true&mute=1'
    }, {
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA TV PUBLIC',
        'url': 'SeñalNASATV_PUBLIC_YOUTUBE.html'
    }, {
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA TV MEDIA',
        'url': 'SeñalNASATV_MEDIA_YOUTUBE.html'
    },{
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA KSC',
        ...
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_LABPADRE.svg"></img>ﾠLAB CAM',
        'url': 'Senal/LabPadre/LabCam.html'
    },  {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_LABPADRE.svg"></img>ﾠROVER CAM',
        'url': 'Senal/LabPadre/RoverCam.html'
    }, {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_LABPADRE.svg"></img>ﾠNerdle Cam 4K',
        'url': 'Senal/LabPadre/NerdleCam4K.html'
    },  {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_LABPADRE.svg"></img>ﾠSAPPHIRE CAM',
        'url': 'Senal/LabPadre/SapphireCam.html'
    },  {
        'nombre': '<img style="height: 40px; width:auto:" src="imagenes/Logo_LABPADRE.svg"></img>ﾠSENTINEL CAM',
