...
var App = {
     channels: {
        ...
        'LabPadre': {
            'nombre': '<img style="height: 20px; width:auto:" src="../../imagenes/Logo_LABPADRE.svg"></img>ﾠLAP PADRE',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="../LabPadre/Stream.html" frameborder="0"></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TextoTitulosMonitor1">ㅤLAB PADREㅤ</div></div></div>'
        }, 
        'LabPadre_LabCam': {
            'nombre': '<img style="height: 20px; width:auto:" src="../../imagenes/Logo_LABPADRE.svg"></img>ﾠLab Cam',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="../LabPadre/LabCam.html" frameborder="0"></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TextoTitulosMonitor1">ㅤLab Camㅤ</div></div></div>'
        }, 
        'LabPadre_Raptor_Roost_Cam': {
            'nombre': '<img style="height: 20px; width:auto:" src="../../imagenes/Logo_LABPADRE.svg"></img>ﾠLaunch Pad Cam',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="../LabPadre/Raptor_Roost_Cam.html" frameborder="0"></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TextoTitulosMonitor1">ㅤRaptor Roost Camㅤ</div></div></div>'
        }, 
        'LabPadre_LaunchPadCam': {
            'nombre': '<img style="height: 20px; width:auto:" src="../../imagenes/Logo_LABPADRE.svg"></img>ﾠLaunch Pad Cam',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="../LabPadre/LaunchPadCam.html" frameborder="0"></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TextoTitulosMonitor1">ㅤLaunch Pad Camㅤ</div></div></div>'
        }, 
        'LabPadre_NerdleCam4K': {
            'nombre': '<img style="height: 20px; width:auto:" src="../../imagenes/Logo_LABPADRE.svg"></img>ﾠNerdle Cam 4K',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="../LabPadre/NerdleCam4K.html" frameborder="0"></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TextoTitulosMonitor1">ㅤNerdle Cam 4Kㅤ</div></div></div>'
        }, 
        'LabPadre_SapphireCam': {
            'nombre': '<img style="height: 20px; width:auto:" src="../../imagenes/Logo_LABPADRE.svg"></img>ﾠSapphire Cam',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="../LabPadre/SapphireCam.html" frameborder="0"></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TextoTitulosMonitor1">ㅤSapphire Camㅤ</div></div></div>'
        }, 
        'LabPadre_SentinelCam': {
            'nombre': '<img style="height: 20px; width:auto:" src="../../imagenes/Logo_LABPADRE.svg"></img>ﾠSentinel Cam',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="../LabPadre/SentinelCam.html" frameborder="0"></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TextoTitulosMonitor1">ㅤSentinel Camㅤ</div></div></div>'
        },
        'RDRONE_UY_Twitch': {
...
init: function() {
    ...
    App.add("cima");
    if (!App.isMobile()) {
        App.add("LabPadre_Raptor_Roost_Cam");
