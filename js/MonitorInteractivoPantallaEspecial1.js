...
var App = {
     channels: {
        'TVPERU': {
            'nombre': '</img><img style="height: 20px; width:auto:" src="imagenes/Logo_YT.svg"></img> TV PERU',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/live_stream?channel=UCkZCoc42IipR1ucqJmIehsA&autoplay=true&mute=1" frameborder="0" allowfullscreen></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TEXTOTituloDePantallaPequeña2">TV PERU</div></div></div>'
        },'AMERICA_NOTICIAS': {
            'nombre': '</img><img style="height: 20px; width:auto:" src="imagenes/Logo_YT.svg"></img> AMERICA NOTICIAS',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/live_stream?channel=UCPhm2I2wk4vqjENwhn3px8A&autoplay=true&mute=1" frameborder="0" allowfullscreen></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TEXTOTituloDePantallaPequeña2">AMERICA NOTICIAS</div></div></div>'
        },'LATINATV': {
            'nombre': '</img><img style="height: 20px; width:auto:" src="imagenes/Logo_YT.svg"></img> LATINA TV',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/live_stream?channel=UC3rDtLrcgr3JS3_3JOW4BAw&autoplay=true&mute=1" frameborder="0" allowfullscreen></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TEXTOTituloDePantallaPequeña2">LATINA TV</div></div></div>'
        },'WILLAXTV': {
            'nombre': '</img><img style="height: 20px; width:auto:" src="imagenes/Logo_YT.svg"></img> WILLAXTV',
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/live_stream?channel=UCort3mldTtMErPqprSlSfng&autoplay=true&mute=1" frameborder="0" allowfullscreen></iframe><div class="CAJATituloDePantallaPequeña2"><div class="TEXTOTituloDePantallaPequeña2">WILLAX TV</div></div></div>'
        },
        '24HTVN': {
