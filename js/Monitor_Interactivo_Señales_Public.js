...
var App = {
     channels: {
        ...
        'PROCESO_CONSTITUCIONAL_YouTube': {
            'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img>PROCESO CONSTITUCIONAL',
        ...
        'TELEMUNDO': {
            'nombre': '<span style="margin-right: 10px;" class="material-icons-round TextoIconoNaranja">cell_tower</span>TELEMUNDO',
