...
var App = {
     channels: {
        ...
        'KBS_WORLD_YT': {
            ...
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/live_stream?channel=UC5BMQOsAB8hKUyHu9KI6yig&autoplay=true&mute=1" frameborder="0" allowfullscreen></iframe><div class="FondoTitulosMonitor1"><div class="TextoTitulosMonitor1">KBS WORLD</div></div></div>',
            'tags': ['Corea del Sur'],
        },
        'KBS_NEWS_YT': {
            ...
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/live_stream?channel=UCcQTRi69dsVYHN3exePtZ1A&autoplay=true&mute=1" frameborder="0" allowfullscreen></iframe><div class="FondoTitulosMonitor1"><div class="TextoTitulosMonitor1">KBS NEWS</div></div></div>',
            'tags': ['Corea del Sur'],
        },
        'YONHAP_TV_NEWS_YT': {
            ...
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/live_stream?channel=UChlgI3UHCOnwUGzWzbJ3H5w&autoplay=true&mute=1" frameborder="0" allowfullscreen></iframe><div class="FondoTitulosMonitor1"><div class="TextoTitulosMonitor1">YONHAP TV NEWS (YTN)</div></div></div>',
            'tags': ['Corea del Sur'],
        },
        'JTBC_NEWS_YT': {
            ...
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/live_stream?channel=UCsU-I-vHLiaMfV_ceaYz5rQ&autoplay=true&mute=1" frameborder="0" allowfullscreen></iframe><div class="FondoTitulosMonitor1"><div class="TextoTitulosMonitor1">JTBC NEWS</div></div></div>',
            'tags': ['Corea del Sur'],
        },
        'SBS_NEWS_YT': {
            ...
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/live_stream?channel=UCkinYTS9IHqOEwR1Sze2JTw&autoplay=true&mute=1" frameborder="0" allowfullscreen></iframe><div class="FondoTitulosMonitor1"><div class="TextoTitulosMonitor1">SBS NEWS</div></div></div>',
            'tags': ['Corea del Sur'],
        },
        'MBC_NEWS_YT': {
            ...
            'code': '<div class="embed-responsive embed-responsive-16by9"> <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/live_stream?channel=UCF4Wxdo3inmxP-Y59wXDsFw&autoplay=true&mute=1" frameborder="0" allowfullscreen></iframe><div class="FondoTitulosMonitor1"><div class="TextoTitulosMonitor1">MBC NEWS</div></div></div>',
            'tags': ['Corea del Sur'],
        },
        //Argentina
        'TN_ARG_YT': {
