let LosCanales = [
    {
        ...
        'titulo': 'ㅤTV+ㅤ',
        'nombre': '<span style="margin-right: 10px; color: #0035FF" class="material-icons">tv</span><img style="height: 20px; width:auto:" src="imagenes/Logo_TVMAS.svg"></img>',
        'url': 'SeñalTVMAS.html'
    }, {
        'titulo': 'ㅤUCV TVㅤ',
        ...
        'titulo': 'ㅤTV CHILEㅤ',
        'nombre': '<span style="margin-right: 10px; color: #0035FF" class="material-icons">tv</span><img style="height: 20px; width:auto:" src="imagenes/Logo_TVCHILE.svg"></img>',
        'url': 'SeñalTVCHILE.html'
    }, {
        'titulo': 'ㅤMEGA PLUSㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 20px; width:auto:" src="imagenes/Logo_MEGAPLUS.svg"></img>',
        ...
        'nombre': '<span style="margin-right: 10px;" class="material-icons">mic</span><img style="height: 20px; width:auto:" src="imagenes/Logo_Radio_Infinita.svg"></img>',
    ...
    {
        'titulo': 'ㅤRUPTLYㅤ',
        'nombre': '<img style="height: 15px; width:auto; margin-right: 10px;" src="imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons">cell_tower</span>RUPTLYﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_AlertaYT.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UC5aeU5hk31cLzq_sAExLVWg&autoplay=true&mute=1'
    }, {
        'titulo': 'ㅤSPUTNIKㅤ',
        'nombre': '<img style="height: 15px; width:auto; margin-right: 10px;" src="imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons">cell_tower</span>SPUTNIKﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_AlertaYT.svg"></img>',
        ...
        'titulo': 'ㅤHISPANTVㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ir.svg"></img>ﾠHISPANTV',
        ...
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width: 25px" src="https://flagcdn.com/qa.svg"></img>ﾠAL JAZEERA ARABIC',
        'url': 'https://www.youtube.com/embed/eJ6ZMd4sVrI?autoplay=true&mute=1'
    }, {
        'titulo': 'ㅤAL JAZEERA ENGㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width: 25px" src="https://flagcdn.com/qa.svg"></img>ﾠAL JAZEERA ENG',
        ...
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/pe.svg"></img>ﾠTV PERU INTERNACIONAL',
        ...
        'titulo': 'ㅤLA 1ㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/es.svg"></img>ﾠLA 1',
        'url': 'SeñalTVE_LA1.html'
    }, {
        'titulo': 'ㅤLA 2ㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/es.svg"></img>ﾠLA 2',
        ...
        'titulo': 'ㅤBBC NEWSㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/gb.svg"></img>ﾠBBC NEWS',
        'url': 'SeñalBBCNEWS.html'
    }, {
        'titulo': 'ㅤBBC WORLD NEWSㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/gb.svg"></img>ﾠBBC WORLD NEWS',
        'url': 'SeñalBBCWORLDNEWS.html'
    }, {
        'titulo': 'ㅤCSPANㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠCSPAN',
        'url': 'SeñaCSPAN.html'
    }, {
        'titulo': 'ㅤABC NEWSㅤ',
        ...
        'titulo': 'ㅤCBS NEWSㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠCBS NEWS LIVE',
        'url': 'SeñalCBSNEWS.html'
    }, {
        'titulo': 'ㅤFOX NEWSㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠFOX NEWS',
        ...
        'titulo': 'ㅤCNNㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠCNN',
        'url': 'SeñalCNN.html'
    }, {
        'titulo': 'ㅤCNN EN ESPAÑOLㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠCNN ESPAÑOL',
        ...
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/es.svg"></img>ﾠ24 HORAS TVE',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UC7QZIf0dta-XPXsp9Hv4dTw&autoplay=true&mute=1'
    }, {
        'titulo': 'ㅤRTㅤ',
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ru.svg"></img>ﾠRTﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_AlertaYT.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCpwvZwUam-URkxB7g4USKpg&autoplay=true&mute=1'
    }, {
        'titulo': 'ㅤRT ESPAÑOLㅤ',
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ru.svg"></img>ﾠRT ESPAÑOLﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_AlertaYT.svg"></img>',
    ...
    {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ua.svg"></img>ﾠKIEV 1 (FOX NEWS)',
        'url': 'https://www.youtube.com/embed/5e-FSBVHv8g?autoplay=true&mute=1'
    },
    //KIEV CAM 2
    {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ua.svg"></img>ﾠKIEV 2 (DW)',
        'url': 'https://www.youtube.com/embed/1e0MV6ox-OE?autoplay=true&mute=1'
    },
    //KIEV CAM 3
    {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ua.svg"></img>ﾠKIEV 3',
        'url': 'https://www.youtube.com/embed/8EihuEbqiBA?autoplay=true&mute=1'
    },
    //KIEV CAM 4
    {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ua.svg"></img>ﾠKIEV (MULTICAM 1)',
        'url': 'https://www.youtube.com/embed/HIPNVm6lNfM?autoplay=true&mute=1'
    },
    //UCRANIA MULTICAM 1
    {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ua.svg"></img>ﾠUCRANIA (MULTICAM 2)',
        'url': 'https://www.youtube.com/embed/JahPwum5PBg?autoplay=true&mute=1'
    },
    //UCRANIA MULTICAM 3
    {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ua.svg"></img>ﾠUCRANIA (MULTICAM 3)',
        'url': 'https://www.youtube.com/embed/iZebYm-nenY?autoplay=true&mute=1'
    },
    //UCRANIA MULTICAM 4
    {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ua.svg"></img>ﾠUCRANIA (MULTICAM 4)',
        'url': 'https://www.youtube.com/embed/x3yMxxAkN4w?autoplay=true&mute=1'
    },
    //UCRANIA MULTICAM 5
    {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ua.svg"></img>ﾠUCRANIA (MULTICAM 5)',
        'url': 'https://www.youtube.com/embed/iUkfhlIvvKQ?autoplay=true&mute=1'
    },
    //UCRANIA MULTICAM 6
    {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/ua.svg"></img>ﾠUCRANIA (MULTICAM 6)',
    ...
    },
    {
        ...
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/cl.svg"></img>ﾠOSORNO PLAZA ARMAS',
        'url': 'Senal/REGIONALES/Camara_Osorno.html'
    }, {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<img style="height: 25px; width:auto:" src="imagenes/Icono_Aviso_Ocasional.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/cl.svg"></img>ﾠCOYHAIQUE (Radio)',
        'url': 'SeñalRADIO_CANALSURPATAGONIA.html'
    },{
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/cl.svg"></img>ﾠCNN',
        'url': 'SeñalInternaCNNCHILE_1_2.html'
    }, {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠWHITE HOUSE',
        ...
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠTIMES SQUARE',
        'url': 'https://www.youtube.com/embed/AdUw5RdyZxI?autoplay=true&mute=1'
    }, {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠTIMES SQUARE: DUFFY SQUARE',
        'url': 'https://www.youtube.com/embed/mNawBricEYw?autoplay=true&mute=1'
    }, {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠTIMES SQUARE: EXPRESS VIEW',
        'url': 'https://www.youtube.com/embed/OBmXqlPxtAQ?autoplay=true&mute=1'
    }, {
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠTIMES SQUARE: 1560 BROADWAY',
        'url': 'https://www.youtube.com/embed/4qyZLflp-sI?autoplay=true&mute=1'
    },{
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/us.svg"></img>ﾠLAS VEGAS',
        ...
        'titulo': 'ㅤTITULOㅤ',
        'nombre': '<img style="height: 25px; width:auto:" src="imagenes/Icono_Aviso_Ocasional.svg"></img>ﾠ<img style="height: 25px; width:auto:" src="imagenes/Icono_Aviso_Ocasional.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span><img style="height: 15px; width:auto:" src="https://flagcdn.com/es.svg"></img>ﾠVOLCAN LA PALMA',
        ...
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>321LAUNCH CAM',
        ...
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>SPACEFLIGHT NOW',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCoLdERT4-TJ82PJOHSrsZLQ&autoplay=true&mute=1'
    },  {
        'titulo': 'ㅤCOSMOSAPIENSㅤ',
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>COSMOSAPIENS ',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UC3ZODI-xZfdPanPP6tKUg9g&autoplay=true&mute=1'
    },  {
        'titulo': 'ㅤINFINITE SPACEㅤ',
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>INFINITE SPACE ',
        ...
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>SPACEX MISSIONS ',
        ...
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>OCEAN CAM',
        ...
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>LAB CAM',
        'url': 'Senal/LabPadre/LabCam.html'
    },  {
        'titulo': 'ㅤSTARBASE: ROVER CAMㅤ',
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>ROVER CAM',
        'url': 'Senal/LabPadre/RoverCam.html'
    }, {
        'titulo': 'ㅤSTARBASE: WERDLE CAMㅤ',
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>Nerdle Cam 4K',
        'url': 'Senal/LabPadre/NerdleCam4K.html'
    },  {
        'titulo': 'ㅤSTARBASE: SAPPHIRE CAMㅤ',
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>SAPPHIRE CAM',
        'url': 'Senal/LabPadre/SapphireCam.html'
    },  {
        'titulo': 'ㅤSTARBASE: SENTINEL CAMㅤ',
        'nombre': '<img style="height: 15px; width:auto:" src="imagenes/Logo_YT.svg"></img>ﾠ<span style="margin-right: 10px;" class="material-icons">photo_camera</span>SENTINEL CAM',
