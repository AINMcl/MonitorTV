let LosCanales = [
    ...
    /*  'titulo': 'TVN',
        'id': 'TVN_1',
        'nombre': '<span id="TVN" style="margin-right: 10px;" class="material-icons-round TextoIconoAzul">tv</span><img id="Logo" style="height: 20px; width: auto; margin-right: 5px;" src="Imagenes/Logo_TVN.svg"></img><span title="RECOMENDADO USAR BLOQUEADOR DE ANUNCIOS" style="margin-left: 5px;" class="BotonAvisoListaSeñales"><span style="font-size: 20px" class="material-icons-round">security</span><span style="font-size: 12px; margin-left: 5px;">USAR BLOQ. ANUNCIOS</span></span>',
        'tags' : ['Chile'],
    ...
    
    {
        ...
        'titulo': 'RADIO INICIA',
        'id': 'RADIO_INICIA',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">mic</span>RADIO INICIA',
        'tags' : ['Chile'],
    ...
    //SEÑALES GOBIERNO
    {
        ...
        'titulo': 'TV DIPUTADOS',
        'id': 'TV_DIPUTADOS_YT',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round TextoIconoRojo">smart_display</span>TV DIPUTADOS',
        'tags' : ['Chile'],
        ...
        'id': 'PROCESO_CONSTITUCIONAL_YT',
        'nombre': '<span id="PROCESOCONSTITUCIONAL" style="margin-right: 10px;" class="material-icons-round TextoIconoRojo">smart_display</span>PROCESO CONSTITUCIONAL',
        'tags' : ['Chile'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCGrlfx5XmVM33MUKPmXc-oA&autoplay=true&mute=1'
    }, {
        'titulo': 'REUTERS',
        'id': 'REUTERS',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">cell_tower</span>REUTERS',
        ...
        'id': 'NBC_LIVE_1',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">cell_tower</span>NBC NEWS NOW LIVE 1',
        'tags' : ['Estados Unidos','Video News'],
        'url': '../Monitores/Senal/NBC_LIVE_1.html'
    }, {
        'titulo': 'NBC NOW LIVE 2',
        'id': 'NBC_LIVE_2',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">cell_tower</span>NBC NEWS NOW LIVE 2',
        'tags' : ['Estados Unidos','Video News'],
        'url': '../Monitores/Senal/NBC_LIVE_2.html'
    }, {
        'titulo': 'NBC NOW LIVE 3',
        'id': 'NBC_LIVE_3',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">cell_tower</span>NBC NEWS NOW LIVE 3',
        'tags' : ['Estados Unidos','Video News'],
        'url': '../Monitores/Senal/NBC_LIVE_3.html'
    }, {
        'titulo': 'NBC NOW LIVE 4',
        'id': 'NBC_LIVE_4',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">cell_tower</span>NBC NEWS NOW LIVE 4',
        'tags' : ['Estados Unidos','Video News'],
        ...
        'titulo': 'EBS',
        'id': 'EBS',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">cell_tower</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/eu.svg" title="UNION EUROPEA"></img>EBS',
        'tags' : ['Union Europea'],
        'url': '../Monitores/Senal/EUROPE_BY_SATELLITE_EBS.html'
    },{
        'titulo': 'EBS+',
        'id': 'EBS_PLUS',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">cell_tower</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/eu.svg" title="UNION EUROPEA"></img>EBS+',
        'tags' : ['Union Europea'],
        'url': '../Monitores/Senal/EUROPE_BY_SATELLITE_EBS_PLUS.html'
    },{
        'titulo': 'OTAN LIVE',
        'id': 'OTAN_LIVE',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">cell_tower</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/eu.svg" title="UNION EUROPEA"></img>OTAN LIVE',
        'tags' : ['Estados Unidos'],
        'url': '../Monitores/Senal/OTAN_LIVE.html'
    },{
        'titulo': 'THE PENTAGON LIVE',
        'id': 'THE_PENTAGON_LIVE',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">cell_tower</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/us.svg" title="ESTADOS UNIDOS"></img>THE PENTAGON LIVE',
        'tags' : ['Estados Unidos'],
        ...
        'titulo': 'EL TRECE',
        'id': 'ELTRECE',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/ar.svg" title="ARGENTINA"></img>EL TRECE',
        'tags' : ['Argentina'],
        'url': '../Monitores/Senal/EL_TRECE.html'
    },{
        'titulo': 'EL NUEVE',
        'id': 'ELNUEVE',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/ar.svg" title="ARGENTINA"></img>EL NUEVE',
        'tags' : ['Argentina'],
        'url': '../Monitores/Senal/EL_NUEVE.html'
    },{
        'titulo': 'ABC TV',
        'id': 'ABC_TV_PAR',
        ...
        'id': 'TVPERU_INTERNACIONAL',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/pe.svg" title="PERU"></img>TV PERU INTERNACIONAL',
        'tags' : ['Peru'],
        ...
        'titulo': 'ECUAVISA',
        'id': 'ECUAVISA',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/ec.svg" title="ECUADOR"></img>ECUAVISA',
        'tags' : ['Ecuador'],
        ...
        'titulo': 'MILENO TV',
        'id': 'MILENIO_TV',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/mx.svg" title="MEXICO"></img>MILENO TV',
        'tags' : ['Mexico'],
        'url': '../Monitores/Senal/MILENIO_TV.html'
    }, {
        'titulo': 'ADN 40',
        'id': 'ADN40',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/mx.svg" title="MEXICO"></img>ADN 40',
        'tags' : ['Mexico'],
        ...
        'id': 'EURONEWS_FRANCES',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/fr.svg" title="FRANCIA"></img>EURONEWS FRANCES',
        'tags' : ['Francia'],
        ...
        'titulo': 'RAI NEWS 24',
        'id': 'RAI_NEWS_24',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/it.svg" title="ITALIA"></img>RAI NEWS 24',
        'tags' : ['Italia'],
        'url': '../Monitores/Senal/RAI_NEWS24.html'
    }, {
        'titulo': '24H RTVE',
        'id': '24HRTVE',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/es.svg" title="ESPAÑA"></img>CANAL 24 HORAS RTVE',
        'tags' : ['España'],
        'url': '../Monitores/Senal/24HORASTVE.html'
    }, {
        'titulo': 'LA 1',
        'id': 'LA_1',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/es.svg" title="ESPAÑA"></img>LA 1',
        'tags' : ['España'],
        'url': '../Monitores/Senal/TVE_LA1.html'
    }, {
        'titulo': 'LA 2',
        'id': 'LA_2',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/es.svg" title="ESPAÑA"></img>LA 2',
        'tags' : ['España'],
        ...
        'titulo': 'RT FRANCÉS',
        'id': 'RT_FRANCES',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/ru.svg" title="RUSIA"></img>RT FRANCÉS',
        'tags' : ['Rusia'],
        'url': '../Monitores/Senal/RT_FRANCE.html'
    }, {
        'titulo': 'RT ALEMÁN',
        'id': 'RT_ALEMAN',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/ru.svg" title="RUSIA"></img>RT ALEMÁN',
        'tags' : ['Rusia'],
        ...
        'titulo': 'HISPANTV',
        'id': 'HISPANTV',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/ir.svg" title="IRÁN"></img>HISPANTV',
        'tags' : ['Iran'],
        ...
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: 25px; margin-right: 10px;" src="https://flagcdn.com/qa.svg" title="CATAR"></img>AL JAZEERA ENGLISH',
        'tags' : ['Catar'],
        'url': '../Monitores/Senal/AL_JAZEERA_EN.html'
    }, {
        'titulo': 'AL JAZEERA ARABIC',
        'id': 'AL_JAZEERA_ARABIC',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: 25px; margin-right: 10px;" src="https://flagcdn.com/qa.svg" title="CATAR"></img>AL JAZEERA ARABIC',
        'tags' : ['Catar'],
        'url': '../Monitores/Senal/AL_JAZEERA_ARABIC.html'
    }, {
        'titulo': 'AL JAZEERA MUBASHER',
        'id': 'AL_JAZEERA_MUBASHER',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: 25px; margin-right: 10px;" src="https://flagcdn.com/qa.svg" title="CATAR"></img>AL JAZEERA MUBASHER',
        'tags' : ['Catar'],
        ...
        'titulo': 'CSPAN',
        'id': 'CSPAN',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/us.svg" title="ESTADOS UNIDOS"></img>CSPAN',
        'tags' : ['Estados Unidos'],
        'url': 'SeñaCSPAN.html'
    }, {
        'titulo': 'ABC NEWS',
        ...
        'nombre': '<span id="CNNINTERNACIONAL" style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/us.svg" title="ESTADOS UNIDOS"></img>CNN INTERNATIONAL',
        'tags' : ['Estados Unidos'],
        ...
        'titulo': 'EURONEWS ENGLISH',
        'id': 'EURONEWS_ENGLISH_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/fr.svg" title="FRANCIA"></img>EURONEWSGLISH',
        'tags' : ['Francia'],
        ...
        'titulo': '24 HORAS TVE',
        'id': '24HRTVE__YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/es.svg" title="ESPAÑA"></img>24 HORAS TVE',
        'tags' : ['España'],
        ...
        'titulo': 'KBS WORLD',
        'id': 'KBS_WORLD_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/kr.svg" title="COREA DEL SUR"></img>KBS WORLD',
        'tags' : ['Corea del Sur'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UC5BMQOsAB8hKUyHu9KI6yig&autoplay=true&mute=1'
    },{
        'titulo': 'KBS NEWS',
        'id': 'KBS_NEWS_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/kr.svg" title="COREA DEL SUR"></img>KBS NEWS',
        'tags' : ['Corea del Sur'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCcQTRi69dsVYHN3exePtZ1A&autoplay=true&mute=1'
    },{
        'titulo': 'YONHAP TV NEWS (YTN)',
        'id': 'YONHAP_TV_NEWS_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/kr.svg" title="COREA DEL SUR"></img>YONHAP TV NEWS (YTN)',
        'tags' : ['Corea del Sur'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UChlgI3UHCOnwUGzWzbJ3H5w&autoplay=true&mute=1'
    },{
        'titulo': 'JTBC NEWS',
        'id': 'JTBC_NEWS_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/kr.svg" title="COREA DEL SUR"></img>JTBC NEWS',
        'tags' : ['Corea del Sur'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCsU-I-vHLiaMfV_ceaYz5rQ&autoplay=true&mute=1'
    },{
        'titulo': 'SBS NEWS',
        'id': 'SBS_NEWS_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/kr.svg" title="COREA DEL SUR"></img>SBS NEWS',
        'tags' : ['Corea del Sur'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCkinYTS9IHqOEwR1Sze2JTw&autoplay=true&mute=1'
    },{
        'titulo': 'MBC NEWS',
        'id': 'MBC_NEWS_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/kr.svg" title="COREA DEL SUR"></img>MBC NEWS',
        'tags' : ['Corea del Sur'],
        ...
        'tags' : ['Argentina'],
        'url': '../Monitores/Senal/AMERICA_TV.html'
    },{
        'titulo': 'A24',
        'id': 'A24_YT',
        ...
        'tags' : ['Argentina'],
        'url': '../Monitores/Senal/CRONICA_TV.html'
    },{
        'titulo': 'LA NACION',
        'id': 'LANACION_YT',
        ...
        'titulo': 'RPP NOTICIAS',
        'id': 'RPP_NOTICIAS_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/pe.svg" title="PERU"></img>RPP NOTICIAS',
        'tags' : ['Peru'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UC5j8-2FT0ZMMBkmK72R4aeA&autoplay=true&mute=1'
    },{
        'titulo': 'LATINA NOTICIAS',
        'id': 'LATINA_NOTICIAS_YT',
        ...
        'titulo': 'ECUADOR TV',
        'id': 'ECUADOR_TV_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/ec.svg" title="ECUADOR"></img>ECUADOR TV<span title="AGREGADO RECIENTEMENTE" style="margin-left: 5px;" class="BotonAvisoListaSeñales"><span style="color: #39AA1A; font-size: 17px" class="material-icons-round">auto_awesome</span><span style="color: #39AA1A; font-size: 12px; margin-left: 5px;">NUEVO</span></span>',
        'tags' : ['Ecuador'],
        ...
        'titulo': 'ECUAVISA',
        'id': 'ECUAVISA_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/ec.svg" title="ECUADOR"></img>ECUAVISA<span title="AGREGADO RECIENTEMENTE" style="margin-left: 5px;" class="BotonAvisoListaSeñales"><span style="color: #39AA1A; font-size: 17px" class="material-icons-round">auto_awesome</span><span style="color: #39AA1A; font-size: 12px; margin-left: 5px;">NUEVO</span></span>',
        'tags' : ['Ecuador'],
        ...
        'titulo': 'CNA NEWS',
        'id': 'CNA_NEWS_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/sg.svg" title="SINGAPORE"></img><span style="margin-right: 10px;">CNA NEWS',
        'tags' : ['Singapore'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UC83jt4dlz1Gjl58fzQrrKZg&autoplay=true&mute=1'
    },{
        //RUSIA
        'titulo': 'RT',
        'id': 'RT_YT',
        ...
        'titulo': 'RUPTLY',
        'id': 'RUPTLY_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">cell_tower</span><span style="margin-right: 10px;"><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/ru.svg" title="RUSIA"></img>RUPTLY</span><span style="margin-left: 5px;" class="BotonAvisoListaSeñales"><span style="font-size: 20px" class="material-icons-round TextoIconoRojo" title="SEÑAL BLOQUEADA POR YOUTUBE">error_outline</span></span>',
        'tags' : ['Rusia'],
        ...
        'titulo': 'CGTN EUROPE',
        'id': 'CGTN_EUROPE',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/cn.svg" title="CHINA"></img>CGTN ESPAÑOL',
        'tags' : ['China'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCj0TppyxzQWm9JbMg3CP8Rg&autoplay=true&mute=1'
    },{
        'titulo': 'CGTN ESPAÑOL',
        'id': 'CGTN_ESPAÑOL',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/cn.svg" title="CHINA"></img>CGTN ESPAÑOL',
        'tags' : ['China'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCd94YCD7yp6d-YZSRYWyeFA&autoplay=true&mute=1'
    },{
        'titulo': 'CGTN FRANCÉS',
        'id': 'CGTN_FRANCES_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/cn.svg" title="CHINA"></img>CGTN ESPAÑOL',
        'tags' : ['China'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCcfLuU0NFT0ZRoQy4jk6GdA&autoplay=true&mute=1'
    },{
        'titulo': 'CGTN ARABIC',
        'id': 'CGTN_ARABIC_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/cn.svg" title="CHINA"></img>CGTN ESPAÑOL',
        'tags' : ['China'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCQmJk0ErE_FiorcLBsDKORA&autoplay=true&mute=1'
    },{
        //CATAR
        'titulo': 'AL JAZEERA ENG',
        'id': 'AL_JAZEERA_ENGLISH_YT',
        ...
        'tags' : ['Chile'],
        'url': '../Monitores/Senal/MEDIABANCO_YT.html'
    },{
        'titulo': 'SERVEL',
        'id': 'SERVEL_YT',
        ...
        'titulo': 'RADIO LA CLAVE',
        'id': 'RADIO_LA_CLAVE_FB',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span>RADIO LA CLAVE',
        'tags' : ['Chile'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCKGi2oU9Eoa5dJAIE7K60gA&autoplay=true&mute=1'
    },{
        'titulo': '24 HORAS',
        'id': '24HTVN_FB',
        ...
        'id': 'TRIBUNAL_CONSTITUCIONAL_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">tv</span>T. CONTITUCIONAL',
        'tags' : ['Chile'],
        ...
        'id': 'TVSENADO_1',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 20px; width: auto; margin-right: 10px;" src="Imagenes/Logo_TVSENADO_2.svg">SEÑAL 1',
        'tags' : ['Chile'],
        'url': '../Monitores/Senal/TVSENADO_1.html'
    },{
        'titulo': 'TV SENADO SEÑAL 2',
        'id': 'TVSENADO_2',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 20px; width: auto; margin-right: 10px;" src="Imagenes/Logo_TVSENADO_2.svg">SEÑAL 2',
        'tags' : ['Chile'],
        'url': '../Monitores/Senal/TVSENADO_2.html'
    },{
        'titulo': 'TV SENADO SEÑAL 3',
        'id': 'TVSENADO_3',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 20px; width: auto; margin-right: 10px;" src="Imagenes/Logo_TVSENADO_2.svg">SEÑAL 3',
        'tags' : ['Chile'],
        'url': '../Monitores/Senal/TVSENADO_3.html'
    },{
        'titulo': 'TV SENADO SEÑAL 4',
        'id': 'TVSENADO_4',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 20px; width: auto; margin-right: 10px;" src="Imagenes/Logo_TVSENADO_2.svg">SEÑAL 4',
        'tags' : ['Chile'],
        'url': '../Monitores/Senal/TVSENADO_4.html'
    },{
        'titulo': 'TV SENADO SEÑAL 5',
        'id': 'TVSENADO_5',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 20px; width: auto; margin-right: 10px;" src="Imagenes/Logo_TVSENADO_2.svg">SEÑAL 5',
        'tags' : ['Chile'],
        'url': '../Monitores/Senal/TVSENADO_5.html'
    },{
        'titulo': 'TV SENADO SEÑAL 6',
        'id': 'TVSENADO_6',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span><img style="height: 20px; width: auto; margin-right: 10px;" src="Imagenes/Logo_TVSENADO_2.svg">SEÑAL 6',
        'tags' : ['Chile'],
        ...
        'id': 'CAM_STGO_SUR_ORIENTE_YT',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round TextoIconoNaranja">photo_camera</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/cl.svg" title="CHILE"></img>STGO. SUR ORIENTE',
        'tags' : ['Chile', 'Santiago'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCMvQGOyumsXP4V7dGAdIKWg&autoplay=true&mute=1'
    },{
        'titulo': 'PEÑALOLEN NORTE',
        'id': 'CAM_PEÑALOLEN_NORTE_YT',
        ...
        'id': 'CAM_VIÑA_DEL_MAR_PLAYA_ACAPULCO',
        ...
        'id': 'CAM_VIÑA_DEL_MAR_PLAYA_REÑACA',
        ...
        'titulo': 'WEBCAMS MEXICO',
        'id': 'CAM_MEXICO',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">photo_camera</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/mx.svg" title="MEXICO"></img>WEBCAMS MEXICO',
        'tags' : ['Mexico'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UColBcWm6ybTbQnNuQS8JaKg&autoplay=true&mute=1'
    },{
        ...
        'id': 'CAM_EARTHCAM',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">photo_camera</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/us.svg" title="ESTADOS UNIDOS"></img>EARTHCAM LIVE',
        'tags' : ['Estados Unidos'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UC6qrG3W8SMK0jior2olka3g&autoplay=true&mute=1'
    },{
        'titulo': 'NEW YORK, BROOKLYN BRIDGE',
        'id': 'CAM_NEW_YORK_BROOKLYN_BRIDGE',
        ...
        'id': 'CAM_NEW_YORK_LOWE_MANHATTAN',
        ...
        'titulo': 'HOTEL FOUR SEASONS',
        'id': 'CAM_HOTEL_FOUR_SEASONS',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">photo_camera</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/ar.svg" title="ARGENTINA"></img> HOTEL FOUR SEASONS',
        'tags' : ['Estados Unidos'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCCkRwmztPEvut3gpsgmCmzw&autoplay=true&mute=1'
    },{
        'titulo': 'USHUAIA',
        'id': 'CAM_USHUAIA',
        ...
        'tags' : ['Argentina'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UC6NTD1HmdaZMbe9K5qADOvw&autoplay=true&mute=1'
    },{
        'titulo': 'CAMARA MUNDO 1 - I LOVE YOU VENICE',
        'id': 'CAM_MUNDO_1',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">photo_camera</span><span style="margin-right: 10px;" class="material-icons-round">language</span>CAMARAS MUNDO 1',
        'tags' : ['Mundo'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCMpn1qLudF-zb4M4bqxLIbw&autoplay=true&mute=1'
    },{
        'titulo': 'CAMARA MUNDO 2 - EARTH TV LIVE',
        'id': 'CAM_MUNDO_2',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">photo_camera</span><span style="margin-right: 10px;" class="material-icons-round">language</span>CAMARAS MUNDO 2',
        'tags' : ['Mundo'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCRuyAVeVd7oUwh0LWmxxBBQ&autoplay=true&mute=1'
    },{
        ...
        //OHIGGINS
        'titulo': 'TELECANAL SANTA CRUZ',
        'id': 'TELECANALSANTACRUZ',
        ...
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span>LOS LAGOS | CASTRO MUNICIPIO TV CASTRO',
        'tags' : ['Chile', 'Los Lagos'],
        ...
        'id': 'RADIOPARANORAMICAINFORMATIVA',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span>AYSEN | RADIO PANORAMICA INFORMATIVA',
        'tags' : ['Chile', 'Aysen'],
        ...
        'id': 'RADIOARCOIRIS',
        'nombre': '<span style="margin-right: 10px;" class="material-icons-round">tv</span>AYSEN | RADIO ARCOIRIS',
        'tags' : ['Chile', 'Aysen'],
        ...
        'id': '321LAUNCHCAM_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">photo_camera</span>321LAUNCH CAM',
        'tags' : ['tags'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCUccOGcvTNrJuihXhYsrp7w&autoplay=true&mute=1'
    }, {
        'titulo': 'SPACEFLIGHT NOW',
        'id': 'SPACEFLIGHTNOW_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">photo_camera</span>SPACEFLIGHT NOW',
        'tags' : ['tags'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCoLdERT4-TJ82PJOHSrsZLQ&autoplay=true&mute=1'
    },  {
        'titulo': 'COSMOSAPIENS',
        'id': 'COSMOSAPIENS_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">photo_camera</span>COSMOSAPIENS ',
        'tags' : ['tags'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UC3ZODI-xZfdPanPP6tKUg9g&autoplay=true&mute=1'
    },  {
        'titulo': 'INFINITE SPACE',
        'id': 'INFINITESPACE_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">photo_camera</span>INFINITE SPACE ',
        'tags' : ['tags'],
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCn8SmzG1xXx_inu-XADxcMg&autoplay=true&mute=1'
    }, {
        'titulo': 'SPACEX MISSIONS',
        'id': 'SPACEXMISSIONS_YT',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons-round">photo_camera</span>SPACEX MISSIONS ',
        'tags' : ['tags'],
