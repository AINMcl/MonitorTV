let LosCanales = [
    ...
    /*    'titulo': 'PANAM SPORTS 1',
        ...
        'titulo': 'CGTN EUROPE',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/cn.svg" title="CHINA"></img>CGTN EUROPE',
        ...
        'titulo': 'CGTN FRANCÉS',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/cn.svg" title="CHINA"></img>CGTN FRANCÉS',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCcfLuU0NFT0ZRoQy4jk6GdA&autoplay=true&mute=1'
    },{
        'titulo': 'CGTN ARABIC',
        'nombre': '<img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_YT.svg"></img><span style="margin-right: 10px;" class="material-icons">tv</span><img style="height: 15px; width: auto; margin-right: 10px;" src="https://flagcdn.com/cn.svg" title="CHINA"></img>CGTN ARABIC',
    ...
    
    {
        ...
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_PoderJudicialTV.svg"></img>SEÑAL 1',
        'url': '../Monitores/Senal/PoderJudicial_1.html'
    },{
        'titulo': 'PODER JUDICIAL TV 2',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_PoderJudicialTV.svg"></img>SEÑAL 2',
        'url': '../Monitores/Senal/PoderJudicial_2.html'
    },{
        'titulo': 'PODER JUDICIAL TV 3',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_PoderJudicialTV.svg"></img>SEÑAL 3',
        'url': '../Monitores/Senal/PoderJudicial_3.html'
    },{
        'titulo': 'PODER JUDICIAL TV 4',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_PoderJudicialTV.svg"></img>SEÑAL 4',
        'url': '../Monitores/Senal/PoderJudicial_4.html'
    },{
        'titulo': 'PODER JUDICIAL TV 5',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_PoderJudicialTV.svg"></img>SEÑAL 5',
        'url': '../Monitores/Senal/PoderJudicial_5.html'
    },{
        'titulo': 'PODER JUDICIAL TV 6',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_PoderJudicialTV.svg"></img>SEÑAL 6',
        'url': '../Monitores/Senal/PoderJudicial_6.html'
    },{
        'titulo': 'PODER JUDICIAL TV 7',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_PoderJudicialTV.svg"></img>SEÑAL 7',
        'url': '../Monitores/Senal/PoderJudicial_7.html'
    },{
        'titulo': 'PODER JUDICIAL TV 8',
        'nombre': '<span style="margin-right: 10px;" class="material-icons">tv</span><img id="Logo" style="height: 15px; width: auto; margin-right: 10px;" src="Imagenes/Logo_PoderJudicialTV.svg"></img>SEÑAL 8',
