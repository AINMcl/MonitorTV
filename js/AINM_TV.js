let LosCanales = [
    {
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CANAL24H.svg"></img>',
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_T13_ENVIVO.svg"></img>ﾠ<img style="height: 15px; width:auto:" src="imagenes/Icono_WebIframe.svg"></img>',
        'url': 'SeñalT13_ENVIVO_IFRAME_AINM_GITHUB.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_TVN.svg"></img>',
        'url': 'SeñalTVN.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_MEGA.svg"></img>',
        'url': 'SeñalMEGA.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CHV.svg"></img>',
        'url': 'SeñalCHV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_Canal13.svg"></img>',
        'url': 'SeñalCANAL13.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_LA_RED.svg"></img>',
        'url': 'SeñalLARED.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_TVMAS.svg"></img>',
        'url': 'SeñalTVMAS.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_UCVTV.svg"></img>',
        'url': 'Señal_UCVTV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_NTV.svg"></img>',
        'url': 'SeñalNTV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_TVCHILE.svg"></img>',
        'url': 'SeñalTVCHILE.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_MEGAPLUS.svg"></img>',
        'url': 'SeñalMEGA_PLUS.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/LogoTV_WappTV.svg"></img>',
        'url': 'SeñalWAPPTV.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_TVN.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_WebIframe.svg"></img>',
        'url': '../Monitores/Senal/WEB/SeñalTVN_IFRAME_AINM_GITHUB.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CHV.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_WebIframe.svg"></img>',
        'url': '../Monitores/Senal/WEB/SeñalCHV_IFRAME.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_Canal13.svg"></img>ﾠ<img style="height: 20px; width:auto:" src="imagenes/Icono_WebIframe.svg"></img>',
        'url': '../Monitores/Senal/WEB/SeñalCANAL13_IFRAME_AINM_GITHUB.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠSEÑAL 1',
        'url': 'SeñalInterna24H_1.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠSEÑAL 2',
        'url': 'SeñalInterna24H_2.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠSEÑAL 3',
        'url': 'SeñalInterna24H_3.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠSEÑAL 4',
        'url': 'SeñalInterna24H_4.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_24HTVN.svg"></img>ﾠSEÑAL 5',
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_MEGANOTICIAS2.svg"></img>ﾠSEÑAL 1',
        'url': 'SeñalInternaMEGANOTICIAS_1.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_MEGANOTICIAS2.svg"></img>ﾠSEÑAL 2',
        'url': 'SeñalInternaMEGANOTICIAS_2.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_MEGANOTICIAS2.svg"></img>ﾠSEÑAL 3',
        'url': 'SeñalInternaMEGANOTICIAS_3.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_MEGANOTICIAS2.svg"></img>ﾠSEÑAL 4',
        'url': 'SeñalInternaMEGANOTICIAS_4.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CNNCHILE2.svg"></img>ﾠSEÑAL 1',
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_BIOBIOCHILE.svg"></img>ﾠSEÑAL 1',
        'url': 'SeñalBIOBIOCHILE_1.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_BIOBIOCHILE.svg"></img>ﾠSEÑAL 2',
        'url': 'SeñalBIOBIOCHILE_2.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_BIOBIOCHILE.svg"></img>ﾠSEÑAL 3',
        'url': 'SeñalBIOBIOCHILE_3.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_BIOBIOCHILE.svg"></img>ﾠSEÑAL 4',
    ...
    
    {
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CHV_NOTICIAS.svg"></img>',
        'url': 'https://www.youtube.com/embed/live_stream?channel=UCRsUoZYC1ULUspipMRnMhwg&autoplay=true&mute=1'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_T13.svg"></img>',
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_24HORAS.svg"></img>',
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_CNNCHILE2.svg"></img>',
        'url': 'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Fcnnchile%2Flive%2F&show_text=0&mute=0'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_MEGANOTICIAS.svg"></img>',
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_T13.svg"></img>',
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_TVN.svg"></img>',
        'url': 'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2Ftvn.cl%2Flive%2F&show_text=0&mute=0'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_MEGA.svg"></img>',
        'url': 'https://www.facebook.com/plugins/video.php?href=https%3A%2F%2Fwww.facebook.com%2FMEGACL%2Flive%2F&show_text=0&mute=0'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_CHV.svg"></img>',
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_Canal13.svg"></img>',
    ...
    
    {
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Facebook.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Microfono1.svg"></img>ﾠCOOPERATIVA',
        'url': 'https://www.facebook.com/plugins/video.php?href=https://www.facebook.com/Cooperativa/live/&show_text=1&mute=0'
    },

    
    {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 1',
        'url': 'Senal/ConvencionConstitucional/Senal1.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 2',
        'url': 'Senal/ConvencionConstitucional/Senal2.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 3',
        'url': 'Senal/ConvencionConstitucional/Senal3.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 4',
        'url': 'Senal/ConvencionConstitucional/Senal4.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 5',
        'url': 'Senal/ConvencionConstitucional/Senal5.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 6',
        'url': 'Senal/ConvencionConstitucional/Senal6.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 7',
        'url': 'Senal/ConvencionConstitucional/Senal7.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 8',
        'url': 'Senal/ConvencionConstitucional/Senal8.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 9',
        'url': 'Senal/ConvencionConstitucional/Senal9.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 10',
        'url': 'Senal/ConvencionConstitucional/Senal10.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 11',
        'url': 'Senal/ConvencionConstitucional/Senal11.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_CC.svg"></img>ﾠCONVENCION CONSTITUCIONAL 12',
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg">ﾠSEÑAL 2ﾠ',
        'url': 'Señal_TVSENADO_2.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg">ﾠSEÑAL 3ﾠ',
        'url': 'Señal_TVSENADO_3.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg">ﾠSEÑAL 4ﾠ',
        'url': 'Señal_TVSENADO_4.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_TVSENADO_2.svg">ﾠSEÑAL 5ﾠ',
    ...
    
    {
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠARICA | CAPPISSIMA TV',
        'url': 'Senal/REGIONALES/CAPPISSIMA_TV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠTARAPACA | IQUIQUE TV',
        'url': 'Senal/REGIONALES/IQUIQUE_TV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠANTOFAGASTA | ANTOFAGASTA TV',
        'url': 'Senal/REGIONALES/ANTOFAGASTA_TV.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠANTOFAGASTA | LRP TV',
        'url': 'Senal/REGIONALES/LRP_TV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠANTOFAGASTA | AM CANAL',
        'url': 'Senal/REGIONALES/AM_CANAL.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠANTOFAGASTA | TALTAL TV',
        'url': 'Senal/REGIONALES/TALTAL_TV.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠATACAMA | ATACAMA TV',
        'url': 'Senal/REGIONALES/ATACAMA_TV.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠCOQUIMBO | MI RADIO TV',
        'url': 'Senal/REGIONALES/MIRADIO_TV.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠVALPARAISO | QUINTA TV',
        'url': 'Senal/REGIONALES/QUINTA_TV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠRM | STGO TV',
        'url': 'Senal/REGIONALES/STGO_TV.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠMAULE | CAMPUS UTALCA TV',
        'url': 'Senal/REGIONALES/CAMPUS_TV.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠMAULE | CONTIVISION',
        'url': 'Senal/REGIONALES/CONTIVISION.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠMAULE | TV5 LINARES',
        'url': 'Senal/REGIONALES/TV5LINARES.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠMAULE | UTV SAN CLEMENTE',
        'url': 'Senal/REGIONALES/TV5LINARES.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠMAULE | TV MAULE SUR',
        'url': 'Senal/REGIONALES/TVMAULESUR.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠBIOBIO | CANAL 9 BIOBIO TV',
        'url': 'Senal/REGIONALES/CANAL9BIOBIOTV.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠBIOBIO | TVU',
        'url': 'Senal/REGIONALES/TVU.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠBIOBIO | TV8',
        'url': 'Senal/REGIONALES/TV8.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠBIOBIO | ENERGIA TV',
        'url': 'Senal/REGIONALES/ENERGIATV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠARAUCANIA | TEMUCO TV',
        'url': 'Senal/REGIONALES/TEMUCO_TV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠARAUCANIA | LTV',
        'url': 'Senal/REGIONALES/LTV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠARAUCANIA | PUCON TV',
        'url': 'Senal/REGIONALES/PUCONTV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠLOS LAGOS | OSORNO TV',
        'url': 'Senal/REGIONALES/OSORNO_TV.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠLOS LAGOS | CANAL 5 PUERTO MONTT',
        'url': 'Senal/REGIONALES/CANAL5_PTOMONTT.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠLOS LAGOS | DECIMA TV',
        'url': 'Senal/REGIONALES/DECIMA_TV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠLOS LAGOS | CANAL 2 QUELLON',
        'url': 'Senal/REGIONALES/CANAL2_QUELLON.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠAYSEN | ROCCO TV COYHAIQUE',
        'url': 'Senal/REGIONALES/ROCCOTV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠAYSEN | SANTA MARIA TV COYHAIQUE',
        'url': 'Senal/REGIONALES/SANTAMARIA_TV.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠAYSEN | CANAL 11 PUERTO AYSEN',
        'url': 'Senal/REGIONALES/CANAL11_AY.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠMAGALLANES | ITV PATAGONIA',
        'url': 'Senal/REGIONALES/ITV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_TV_News.svg"></img>ﾠMAGALLANES | PINGUINO TV',
        'url': 'Senal/REGIONALES/PINGUINO_TV.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_ALOMAX.svg"></img>ﾠDETECTOR SISMOS',
        'url': 'MonitorEARLY-EST_DETECTOR.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_ALOMAX.svg"></img>ﾠULTIMOS SISMOS',
        ...
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA TV MEDIA',
        'url': 'SeñalNASATVMEDIA.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠISS CAM SD',
        'url': 'Señal_ISS_SD.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠISS CAM HD',
        'url': 'Señal_ISS_HD.html'
    },{
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Ubicacion.svg"></img>ﾠ<img style="height: 40px; width:auto:" src="imagenes/Logo_ESA.svg"></img>ﾠISS TRACKER MAP 1',
        'url': 'Señal_ISS_TRACKER.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Ubicacion.svg"></img>ﾠISS TRACKER MAP 2',
        'url': 'ESPACIO_RASTREO_ISS.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Ubicacion.svg"></img>ﾠISS TRACKER MAP 3',
        'url': 'ESPACIO_RASTREO_ISS_2_2.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Icono_Ubicacion.svg"></img>ﾠISS TRACKER MAP 4',
        'url': 'ESPACIO_RASTREO_ISS_3.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA CSBF OPERATIONS',
        'url': 'SeñalNASATV_CSBF.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA LaRC',
        'url': 'SeñalNASATV_LaRC.html'
    }, {
        'nombre': '<img style="height: 30px; width:auto:" src="imagenes/Logo_NASA.svg"></img>ﾠNASA WALLOPS',
